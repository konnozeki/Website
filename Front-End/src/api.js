...
export const RETRIEVE_UPDATE_DELETE_USER_API = HOST + '/api/user/' 
...
export const ADMIN_DELETE_CATEGORY_API = function (id) {
  return HOST + API + 'admin/category/' + id + '/'
}
...
export const CREATE_RATE_FILM_EPISODE_API = function (film_slug, film_episode_slug) {
  return HOST + API + 'film/' + film_slug + '/episode/' + film_episode_slug + '/rate/'
}
...
export const UPDATE_DELETE_COMMENT_FOR_FILM_API = function (film_slug, pk) {
  return HOST + API + 'film/' + film_slug + '/comments/' + pk + '/'
}
